...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React84 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState6 = React84.useState, useEffect16 = React84.useEffect, useLayoutEffect = React84.useLayoutEffect, useDebugValue = React84.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React84 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore = shim.useSyncExternalStore, useRef11 = React84.useRef, useEffect16 = React84.useEffect, useMemo15 = React84.useMemo, useDebugValue = React84.useDebugValue;
...
function createContinuousScaleGetAxisFilter(scaleType, extrema, zoomStart, zoomEnd, direction, axisData) {
  let min3;
  let max3;
  [min3, max3] = getScale(scaleType ?? "linear", extrema, [0, 100]).nice().domain();
...
var AnimatedLine = React25.forwardRef(function AnimatedLine2(props, ref) {
  const {
    skipAnimation,
    ownerState
...
function MarkPlot(props) {
  ...
  const highlightedItems = React31.useMemo(() => {
    const rep = {};
    for (const {
      dataIndex,
      axisId
        ...
        return (0, import_jsx_runtime12.jsx)("g", {
          ...
          children: xData?.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime12.jsx)(Mark, _extends({
              ...
              isHighlighted: highlightedItems[xAxisId]?.has(index2) || isSeriesHighlighted,
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React32.useState(typeof window !== "undefined" || false);
  React32.useEffect(() => {
    setIsHydrated(true);
  }, []);
  return isHydrated;
...
function getTicks(options) {
  ...
  const ticks = typeof tickInterval === "object" ? tickInterval : getDefaultTicks(scale2, tickNumber);
  const visibleTicks = [];
  for (let i = 0; i < ticks.length; i += 1) {
    const value = ticks[i];
    const offset = scale2(value);
    if (isInside(offset)) {
      const defaultTickLabel = scale2.tickFormat(tickNumber)(value);
      visibleTicks.push({
        value,
        formattedValue: valueFormatter?.(value, {
          location: "tick",
...
function getDefaultTicks(scale2, tickNumber) {
  const domain = scale2.domain();
  if (domain[0] === domain[1]) {
    return [domain[0]];
  }
  return scale2.ticks(tickNumber);
}
function useTicks(options) {
  ...
  return React33.useMemo(() => getTicks({
    scale: scale2,
    tickNumber,
    tickPlacement,
    tickInterval,
    ...
    valueFormatter,
    isInside
  }), [scale2, tickNumber, tickPlacement, tickInterval, tickLabelPlacement, valueFormatter, isInside]);
}
...
function ChartsSingleXAxisTicks(inProps) {
  ...
  return (0, import_jsx_runtime14.jsx)(React36.Fragment, {
...
function useTicksGrouped(options) {
  ...
  return React37.useMemo(() => {
    ...
    if (scale2.bandwidth() > 0) {
      const entries = mapToGrouping(filteredDomain, groups2, tickPlacement, tickLabelPlacement, scale2);
      if (entries[0]) {
    ...
    return mapToGrouping(filteredDomain, groups2, tickPlacement, tickLabelPlacement, scale2);
  }, [scale2, tickInterval, groups2, tickPlacement, tickLabelPlacement]);
}
function mapToGrouping(tickValues, groups2, tickPlacement, tickLabelPlacement, scale2) {
  const allTickItems = [];
  ...
  for (let groupIndex = 0; groupIndex < groups2.length; groupIndex += 1) {
    for (let dataIndex = 0; dataIndex < tickValues.length; dataIndex += 1) {
      ...
      if (isNew) {
        currentValueCount = 1;
        const tickOffset = isBandScale(scale2) ? scale2(tickValue) - (scale2.step() - scale2.bandwidth()) / 2 + offsetRatio2[tickPlacement] * scale2.step() : scale2(tickValue);
        const labelOffset = scale2.step() * currentValueCount * (offsetRatio2[tickLabelPlacement] - offsetRatio2[tickPlacement]);
        allTickItems.push({
          value: groupValue,
    ...
    children: xTicks.map((item, index2) => {
      ...
      return (0, import_jsx_runtime15.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime15.jsx)(Tick, _extends({
          y2: tickYSize,
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime15.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: labelPositionY
        }, axisTickLabelProps, {
...
function ChartsXAxisImpl(_ref) {
  let {
    axis
  } = _ref, inProps = _objectWithoutPropertiesLoose(_ref, _excluded14);
  const {
    scale: xScale
  ...
  return (0, import_jsx_runtime16.jsxs)(XAxisRoot, {
    ...
    }, slotProps?.axisLine)), children, label && (0, import_jsx_runtime16.jsx)("g", {
    ...
    children: yTicks.map((item, index2) => {
      ...
      return (0, import_jsx_runtime18.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime18.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && !skipLabel && (0, import_jsx_runtime18.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: tickLabel
        }, axisTickLabelProps))]
    ...
    children: yTicks.map((item, index2) => {
      ...
      return (0, import_jsx_runtime19.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime19.jsx)(Tick, _extends({
          x2: tickXSize,
          className: classes.tick
        }, slotProps?.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime19.jsx)(TickLabel, _extends({
          x: labelPositionX,
          y: yTickLabel
        }, axisTickLabelProps, {
          style: _extends({}, axisTickLabelProps.style, groupConfig.tickLabelStyle),
...
function ChartsYAxisImpl(_ref) {
  let {
    axis
  } = _ref, inProps = _objectWithoutPropertiesLoose(_ref, _excluded16);
  const {
    scale: yScale
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React45.Fragment, {
    children: [xAxisIds.map((axisId) => {
      ...
      return (0, import_jsx_runtime22.jsx)(ChartsXAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
      ...
      return (0, import_jsx_runtime22.jsx)(ChartsYAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
...
var consumeThemeProps = (name, options, InComponent) => React46.forwardRef(function ConsumeThemeInternal(props, ref) {
  const themedProps = useThemeProps({
    props,
  ...
  const OutComponent = React46.forwardRef(InComponent);
...
var _excluded17 = ["type", "color", "className", "classes"];
  ...
  return (0, import_jsx_runtime24.jsx)(Root, _extends({
    ...
    children: (0, import_jsx_runtime24.jsx)("div", {
      ...
      children: typeof Component === "function" ? (0, import_jsx_runtime24.jsx)(Component, {
        ...
        color: color2
      }) : (0, import_jsx_runtime24.jsx)("svg", {
        viewBox: "0 0 24 24",
        preserveAspectRatio: type === "line" ? "none" : void 0,
        children: type === "circle" ? (0, import_jsx_runtime24.jsx)("circle", {
          className: classes?.fill,
          r: "12",
          cx: "12",
          cy: "12",
      ...
      children: (0, import_jsx_runtime25.jsxs)(ChartsTooltipTable, {
        ...
        children: [(0, import_jsx_runtime25.jsxs)(Typography_default, {
          ...
          children: tooltipData.values.map(({
            ...
            label: label2
          }) => (0, import_jsx_runtime25.jsxs)(ChartsTooltipRow, {
...
function useColorProcessor(seriesType) {
  const store = useStore();
  const seriesConfig5 = useSelector(store, selectorChartSeriesConfig);
  const colorProcessors = React49.useMemo(() => {
    const rep = {};
...
function usePointerType() {
  ...
  const [pointerType, setPointerType] = React50.useState(null);
  React50.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
var _excluded18 = ["trigger", "classes", "children"];
var noAxis = () => false;
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React52.useMemo(() => ({
  ...
  return (0, import_jsx_runtime27.jsx)(NoSsr_default, {
    children: isOpen && (0, import_jsx_runtime27.jsx)(ChartsTooltipRoot, _extends({
      className: classes?.root,
      open: isOpen,
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  ...
  return React54.forwardRef(ConsumeSlotsInternal);
};
...
var _excluded21 = ["direction", "onItemClick", "className", "classes"];
...
}, React56.forwardRef(function ChartsLegend2(props, ref) {
  ...
  return (0, import_jsx_runtime31.jsx)(RootElement, _extends({
    ...
    children: data.items.map((item, i) => {
      return (0, import_jsx_runtime31.jsx)("li", {
        ...
        "data-series": item.id,
        children: (0, import_jsx_runtime31.jsxs)(Element, {
...
var _excluded26 = ["gradientId", "direction", "classes", "className", "rotate", "reverse", "thickness"];
...
var _excluded27 = ["minLabel", "maxLabel", "direction", "axisDirection", "axisId", "rotateGradient", "reverse", "classes", "className", "gradientId", "labelPosition", "thickness"];
...
var _excluded28 = ["direction", "classes", "className", "markType", "labelPosition", "axisDirection", "axisId", "labelFormatter", "onItemClick"];
...
function ChartsYHighlight(props) {
  ...
  return axisYValues.map(({
    ...
    return (0, import_jsx_runtime35.jsxs)(React60.Fragment, {
      children: [isBandScaleY && yScale(value) !== void 0 && (0, import_jsx_runtime35.jsx)(ChartsAxisHighlightPath, {
...
function ChartsXHighlight(props) {
  ...
  return axisXValues.map(({
    ...
    return (0, import_jsx_runtime36.jsxs)(React61.Fragment, {
      children: [isBandScaleX && xScale(value) !== void 0 && (0, import_jsx_runtime36.jsx)(ChartsAxisHighlightPath, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime37.jsxs)(React62.Fragment, {
...
var reactMajor_default = parseInt(React64.version, 10);

// node_modules/@mui/x-charts/esm/LineChart/LineHighlightElement.js
var import_jsx_runtime39 = __toESM(require_jsx_runtime(), 1);
var _excluded29 = ["x", "y", "id", "classes", "color", "shape"];
...
var _excluded30 = ["slots", "slotProps"];
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime41.jsx)(React67.Fragment, {
    children: xTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime41.jsx)(GridLine, {
      y1: start,
      y2: end,
      x1: offset,
      x2: offset,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime42.jsx)(React68.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime42.jsx)(GridLine, {
      y1: offset,
      y2: offset,
      x1: start,
      x2: end,
...
var _excluded31 = ["vertical", "horizontal"];
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime43.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime43.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      start: drawingArea.top,
      end: drawingArea.height + drawingArea.top,
      classes
    }), horizontal && (0, import_jsx_runtime43.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime46.jsx)(LoadingOverlay, _extends({}, props.slotProps?.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = props.slots?.noDataOverlay ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime46.jsx)(NoDataOverlay, _extends({}, props.slotProps?.noDataOverlay));
  }
  return null;
}
...
// node_modules/@mui/x-charts/esm/LineChart/useLineChartProps.js
var _excluded34 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "onAreaClick", "onLineClick", "onMarkClick", "axisHighlight", "disableLineItemHighlight", "hideLegend", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "className", "showToolbar"];
var useLineChartProps = (props) => {
  ...
  const seriesWithDefault = React73.useMemo(() => series.map((s2) => _extends({
...
var _excluded35 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "onAxisClick", "highlightedAxis", "onHighlightedAxisChange", "disableVoronoi", "voronoiMaxRadius", "onItemClick", "disableAxisListener", "highlightedItem", "onHighlightChange", "sx", "title", "xAxis", "yAxis", "zAxis", "rotationAxis", "radiusAxis", "skipAnimation", "seriesConfig", "plugins", "localeText", "slots", "slotProps", "experimentalFeatures"];
...
var ChartsSlotsContext = React75.createContext(null);
...
var _excluded36 = ["children", "localeText", "plugins", "seriesConfig", "slots", "slotProps"];
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(ChartProvider, _extends({}, chartProviderProps, {
...
true ? ChartDataProvider.propTypes = {
   ...
   */
  experimentalFeatures: import_prop_types30.default.shape({
    preferStrictDomainInLineCharts: import_prop_types30.default.bool
  }),
  /**
...
var _excluded37 = ["children", "className", "title", "desc"];
...
var ChartsSurface = React81.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime53.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime53.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime53.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime53.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
function ChartsWrapper(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(Root3, {
    ref: chartRootRef,
    ownerState: props,
    sx,
...
true ? ChartsWrapper.propTypes = {
   ...
   */
  extendVertically: import_prop_types32.default.bool,
  /**
   * The direction of the legend.
   * @default 'horizontal'
   */
  legendDirection: import_prop_types32.default.oneOf(["horizontal", "vertical"]),
  /**
   * The position of the legend.
   * @default { horizontal: 'center', vertical: 'bottom' }
   */
  legendPosition: import_prop_types32.default.shape({
    horizontal: import_prop_types32.default.oneOf(["center", "end", "start"]),
    vertical: import_prop_types32.default.oneOf(["bottom", "middle", "top"])
  }),
...
var LineChart = React83.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  return (0, import_jsx_runtime55.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime55.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar ? (0, import_jsx_runtime55.jsx)(Toolbar, _extends({}, props.slotProps?.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime55.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime55.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime55.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime55.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime55.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime55.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime55.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime55.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
        })), (0, import_jsx_runtime55.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime55.jsx)("g", {
          "data-drawing-container": true,
          children: (0, import_jsx_runtime55.jsx)(MarkPlot, _extends({}, markPlotProps))
        }), (0, import_jsx_runtime55.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime55.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime55.jsx)(Tooltip, _extends({}, props.slotProps?.tooltip))]
    }))
  }));
});
...
true ? LineChart.propTypes = {
   ...
   * Options to enable features planned for the next major.
   */
  experimentalFeatures: import_prop_types33.default.shape({
    preferStrictDomainInLineCharts: import_prop_types33.default.bool
  }),
  /**
   ...
   */
  highlightedAxis: import_prop_types33.default.arrayOf(import_prop_types33.default.shape({
    axisId: import_prop_types33.default.oneOfType([import_prop_types33.default.number, import_prop_types33.default.string]).isRequired,
   ...
   */
  onHighlightedAxisChange: import_prop_types33.default.func,
  /**
  ...
  xAxis: import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.shape({
    ...
    groups: import_prop_types33.default.arrayOf(import_prop_types33.default.shape({
      getValue: import_prop_types33.default.func.isRequired,
    ...
    constant: import_prop_types33.default.number,
    data: import_prop_types33.default.array,
    dataKey: import_prop_types33.default.string,
    disableLine: import_prop_types33.default.bool,
    disableTicks: import_prop_types33.default.bool,
    ...
    position: import_prop_types33.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types33.default.bool,
    scaleType: import_prop_types33.default.oneOf(["symlog"]),
    slotProps: import_prop_types33.default.object,
    slots: import_prop_types33.default.object,
    sx: import_prop_types33.default.oneOfType([import_prop_types33.default.arrayOf(import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object, import_prop_types33.default.bool])), import_prop_types33.default.func, import_prop_types33.default.object]),
    tickInterval: import_prop_types33.default.oneOfType([import_prop_types33.default.oneOf(["auto"]), import_prop_types33.default.array, import_prop_types33.default.func]),
