...
var Portal = React39.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React39.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
function useEventCallback(fn2) {
  const ref = React46.useRef(fn2);
  useEnhancedEffect_default(() => {
    ref.current = fn2;
  });
  return React46.useRef((...args) => (
...
function useLazyRef(init, initArg) {
  const ref = React47.useRef(UNINITIALIZED);
...
`;
var TouchRipple = React57.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  const start2 = React57.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
...
var ButtonBase = React58.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
...
var IconButton = React60.forwardRef(function IconButton2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiIconButton"
  });
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types39.default.node, (props) => {
    const found = React60.Children.toArray(props.children).some((child) => React60.isValidElement(child) && child.props.onClick);
    if (found) {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QSU6RU25.js.map
