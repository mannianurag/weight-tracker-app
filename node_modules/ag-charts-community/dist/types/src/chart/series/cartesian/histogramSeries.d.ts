import { type Point, type RequireOptional } from 'ag-charts-core';
...
import { type CartesianAnimationData, CartesianSeries, type CartesianSeriesNodeDataContext } from './cartesianSeries';
...
export declare class HistogramSeries extends CartesianSeries<Rect<HistogramNodeDatum>, AgHistogramSeriesOptions, HistogramSeriesProperties, HistogramNodeDatum, HistogramNodeDatum, HistogramSeriesNodeDataContext> {
    ...
    createNodeData(): {
        ...
        visible: boolean;
        styles: Record<HighlightState, RequireOptional<AgHistogramSeriesStyle>>;
    } | undefined;
