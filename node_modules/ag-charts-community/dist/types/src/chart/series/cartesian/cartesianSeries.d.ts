...
export declare abstract class CartesianSeries<TNode extends Node<any>, TOpts extends object, TProps extends CartesianSeriesProperties<TOpts>, TDatum extends CartesianSeriesNodeDatum, TLabel extends SeriesNodeDatum<number> = TDatum, TContext extends CartesianSeriesNodeDataContext<TDatum, TLabel> = CartesianSeriesNodeDataContext<TDatum, TLabel>, TStackContext = never> extends DataModelSeries<TDatum, TOpts, TProps, TLabel, TContext> {
    ...
    protected readonly dataNodeGroup: SegmentedGroup;
    ...
    seriesBelowStackContext: TStackContext | undefined;
    ...
    createStackContext(): TStackContext | undefined;
    ...
    protected pickNodeDataClosestDatum(point: Point): {
        datum: SeriesNodeDatum<DatumIndexType> | undefined;
        distance: number;
    } | undefined;
    private pickModulesClosestDatum;
    ...
    protected zoomFittingVisibleItems(crossAxisKey: string, _axisKeys: string[], xVisibleRange: [number, number], yVisibleRange: [number, number] | undefined, minVisibleItems: number): {
        x: [number, number];
