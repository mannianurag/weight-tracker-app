...
export interface SeriesAreaChartDependencies {
    ...
    getTooltipContent: <DatumIndex extends DatumIndexType>(series: UnknownSeries, datumIndex: DatumIndex, removeThisDatum: unknown, purpose: 'aria-label' | 'tooltip') => TooltipContent[];
    chartType: ChartType;
