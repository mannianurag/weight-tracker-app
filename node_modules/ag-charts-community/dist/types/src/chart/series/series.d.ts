import { type AnyFn, CleanupRegistry, EventEmitter, LRUCache, type Point, type RequireOptional } from 'ag-charts-core';
import type { AgChartLabelFormatterParams, AgInitialStateLegendOptions, AgSeriesMarkerStyle, AgSeriesTooltipRendererParams, AgSeriesVisibilityChange, FormatterPropertyType, HighlightState as PublicHighlightState } from 'ag-charts-types';
...
export type INodeEventConstructor<TDatum extends SeriesNodeDatum<DatumIndexType>, TSeries extends Series<any, TDatum, object, any>, TEvent extends string = SeriesNodeEventTypes> = new <T extends TEvent>(type: T, event: Event, { datum }: TDatum, series: TSeries) => INodeEvent<T>;
export declare class SeriesNodeEvent<TDatum extends SeriesNodeDatum<DatumIndexType>, TEvent extends string = SeriesNodeEventTypes> implements INodeEvent<TEvent> {
    ...
    constructor(type: TEvent, event: Event, nodeDatum: TDatum, series: ISeries<DatumIndexType, TDatum, unknown, unknown>);
    preventDefault(): void;
}
...
export declare abstract class Series<TDatumIndex extends DatumIndexType, TDatum extends SeriesNodeDatum<TDatumIndex>, TOpts extends object, TProps extends SeriesProperties<TOpts>, TLabel = TDatum, TContext extends SeriesNodeDataContext<TDatumIndex, TDatum, TLabel> = SeriesNodeDataContext<TDatumIndex, TDatum, TLabel>> extends Observable implements ISeries<TDatumIndex, TDatum, TProps, TLabel> {
    ...
    getOpacity(): number;
    protected getHighlightState(highlightedDatum: HighlightNodeDatum | undefined, isHighlight?: boolean, datumIndex?: TDatumIndex, legendItemValues?: string[]): HighlightState;
    ...
    protected getHighlightStyle(isHighlight?: boolean, datumIndex?: TDatumIndex, highlightState?: HighlightState, legendItemValues?: string[]): Partial<TOpts & {
